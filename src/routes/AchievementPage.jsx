...
const AchievementPage = ({ entries = [], physicalEntries = [], mentalEntries = [] }) => {
  ...
  useEffect(() => {
    const calculateAchievements = () => {
      ...
      console.log(`Calculated stats for ${selectedCategory}:`, {
        totalHours,
        totalSessions,
        averageHours
      });
  ...
  }, [entries, physicalEntries, mentalEntries, timeframe, selectedCategory, refreshTrigger]);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center gap-4 mt-4">
            ...
            <button
              onClick={() => {
                if (window.confirm("Are you sure you want to clear all data? This will start fresh with no previous session data.")) {
